...
- common local graph and post-transform import diagnostics include source locations; local graph diagnostics map to the original caller source, while post-transform validation diagnostics currently map to generated emitted module source until full source maps are added;
